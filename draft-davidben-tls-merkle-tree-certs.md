...
For initial experimentation, early implementations of this design will use the OID 1.3.6.1.4.1.44363.47.0 instead of `id-alg-mtcProof`. This OID also does not omit the identifier and length octets in `tbs_cert_entry_data`. (See {{log-entries}}).
